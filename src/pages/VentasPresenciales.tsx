...
export default function VentasPresenciales() {
    ...
    const registrarVenta = async () => {
        ...
        if (cajaId) {
            ...
            if (cajaSnap.exists()) {
                ...
                await addDoc(collection(db, "tiendas", tiendaId!, "cajas", cajaId, "ventas"), venta);
            }
        }
    ...
    const exportarExcel = () => {
        ...
        XLSX.writeFile(wb, `ventas_${fechaHoy}_${empleado}.xlsx`);
    };

    if (!esEmpleado) {
        return <p style={{ textAlign: "center" }}>🔒 Acceso solo para empleados</p>;
    }

    if (!tiendaId) {
        return <p style={{ textAlign: "center" }}>⚠️ Tienda no identificada</p>;
    }
            ...
            {!cajaAbierta ? (
                ...
                <>
                    ...
                    <textarea
                        ...
                        placeholder="Dejá instrucciones o notas para el cierre de caja..."
