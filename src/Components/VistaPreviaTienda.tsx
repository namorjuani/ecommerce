    ...
    return (
        <div style={{ backgroundColor: colorFondo, color: "#000", padding: "1rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                {logo ? (
                    <img src={logo} alt="logo" style={{ height: 50 }} onError={(e) => (e.currentTarget.src = "/logo.png")} />
                ) : (
                    <img src="/logo.png" alt="logo por defecto" style={{ height: 50 }} />
                )}
            ...
            <div
                style={{
                    ...
                    marginTop: "1rem",
                    backgroundColor: !imagen ? "#ccc" : undefined, // fondo de relleno si no hay imagen
                }}
            >
