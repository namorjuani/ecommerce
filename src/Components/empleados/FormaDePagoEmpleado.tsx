// ✅ FormaDePagoEmpleado.tsx
import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { useCarrito } from "../../context/CarritoContext";
import { useAuth } from "../../context/AuthContext";
import { db } from "../../firebase";
import { doc, getDoc, writeBatch, addDoc, Timestamp, updateDoc, collection, query, where, getDocs } from "firebase/firestore";
        ...
        <div style={{ maxWidth: "600px", margin: "2rem auto", padding: "1rem" }}>
            ...
            {formaPago === "efectivo" && (
                <div style={{ marginBottom: "1rem" }}>
                    ...
                    />
                    {vuelto >= 0 && (
                        <p style={{ marginTop: "0.5rem" }}>Vuelto a entregar: <strong>${vuelto.toFixed(2)}</strong></p>
                    )}
                </div>
            )}
            ...
            {formaPago === "mercadopago" && (
                <div style={{ background: "#f1f1f1", padding: "1rem", borderRadius: "6px" }}>
                    ...
                    <p><strong>{/* podés completar con datos reales */}alias.mp/tu_tienda</strong></p>
                </div>
            )}
