  ...
  return (
    <section style={{ backgroundColor: "#f1f1f1", padding: "2rem 1rem", marginTop: "2rem" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", flexWrap: "wrap", gap: "2rem" }}>
        ...
        <div style={{ flex: 1, minWidth: "300px", height: "280px", borderRadius: "6px", overflow: "hidden", boxShadow: "0 0 10px rgba(0,0,0,0.1)" }}>
          <div dangerouslySetInnerHTML={{ __html: googleMaps }} style={{ width: "100%", height: "100%" }} />
        </div>
      </div>
    </section>
  );
